      ...
      <div className="mt-5 mx-5 p-5 pt-3 bg-white rounded-xl border">
        ...
        <div className="grid grid-cols-4 gap-4 break-all">
          ...
          <div className="border rounded-lg p-3 bg-white">
            ...
            <p className="text-sm opacity-70">{investorApi?.startup_location_preference?.global?.toString()}</p>
          </div>
          ...
          <div className="border rounded-lg p-3 bg-white">
            ...
            <p className="text-sm opacity-70">{investorApi?.lead_investor_required?.toString()}</p>
          </div>

          <div className="border rounded-lg p-3 bg-white">
            <h4 className="text-sm font-semibold">SC/ST/OBC Preference</h4>
            <p className="text-sm opacity-70">{investorApi?.preference?.sc_st_obc?.toString()}</p>
          </div>
          <div className="border rounded-lg p-3 bg-white">
            <h4 className="text-sm font-semibold">Women Prefrence</h4>
            <p className="text-sm opacity-70">{investorApi?.preference?.women?.toString()}</p>
          </div>
        </div>
      </div>
